  ...
  return (
    <div className={`min-h-screen transition-colors duration-500 ${
      ...
      <nav className={`fixed w-full z-40 transition-all duration-500 ${
        ...
        {/* Mobile Menu */}
        {isMenuOpen && (
          <div className={`lg:hidden transition-colors duration-300 border-t shadow-lg ${
            isDarkMode 
            ...
            <div className="px-4 py-3 space-y-2">
              {['home', 'about', 'skills', 'projects', 'experience', 'contact'].map((item) => (
                <button
                  key={item}
                  onClick={() => scrollToSection(item)}
                  className={`block w-full text-left capitalize px-4 py-3 rounded-lg transition-colors text-sm ${
                    activeSection === item
      ...
      <section id="home" className="min-h-screen flex items-center relative pt-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className={`absolute top-0 left-1/4 w-64 h-64 sm:w-96 sm:h-96 rounded-full blur-3xl opacity-30 sm:opacity-50 transition-colors duration-500 ${
            isDarkMode ? 'bg-violet-900' : 'bg-violet-100'
          }`} />
          <div className={`absolute bottom-0 right-1/4 w-64 h-64 sm:w-96 sm:h-96 rounded-full blur-3xl opacity-30 sm:opacity-50 transition-colors duration-500 ${
        ...
        <div className="max-w-7xl mx-auto w-full">
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-20 items-center">
            ...
            <div className="space-y-6 sm:space-y-8 relative z-10 order-2 lg:order-1">
              <div className={`inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full border transition-all duration-300 ${
                isDarkMode 
              ...
              <div className={`text-lg sm:text-xl lg:text-2xl h-10 sm:h-12 flex items-center transition-colors duration-300 ${
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-2">
                ...
                <button
                  ...
                  className={`px-6 sm:px-8 py-3 sm:py-4 border-2 rounded-xl font-semibold transition-all duration-300 flex items-center justify-center gap-2 sm:gap-3 text-sm sm:text-base ${
                    isDarkMode 
            ...
            <div className="relative flex justify-center items-center order-1 lg:order-2 mb-8 lg:mb-0">
              <div className="relative">
                {/* Decorative circles */}
                <div className={`absolute -top-4 -left-4 w-40 h-40 sm:w-48 sm:h-48 rounded-full blur-xl opacity-30 sm:opacity-60 transition-colors duration-500 ${
                  isDarkMode ? 'bg-gradient-to-br from-violet-800 to-purple-800' : 'bg-gradient-to-br from-violet-200 to-purple-200'
                }`} />
                <div className={`absolute -bottom-4 -right-4 w-40 h-40 sm:w-48 sm:h-48 rounded-full blur-xl opacity-30 sm:opacity-60 transition-colors duration-500 ${
                  isDarkMode ? 'bg-gradient-to-br from-purple-800 to-pink-800' : 'bg-gradient-to-br from-purple-200 to-pink-200'
                }`} />
                
                {/* Profile image container */}
                <div className="relative z-10">
                  <div className={`relative w-64 h-64 sm:w-72 sm:h-72 lg:w-96 lg:h-96 rounded-2xl sm:rounded-3xl overflow-hidden shadow-xl sm:shadow-2xl ring-2 sm:ring-4 transition-all duration-500 ${
      ...
      {/* About Section */}
      <section id="about" className={`py-16 sm:py-24 px-4 sm:px-6 lg:px-8 transition-colors duration-500 ${
      ...
      {/* Skills Section */}
      <section id="skills" className={`py-16 sm:py-24 px-4 sm:px-6 lg:px-8 transition-colors duration-500 ${
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {skills.map((skill) => (
              <div
                key={skill.name}
                className={`group p-4 sm:p-6 rounded-2xl border transition-all duration-300 hover:scale-105 ${
                  isDarkMode 
      ...
      {/* Experience Section */}
      <section id="experience" className={`py-16 sm:py-24 px-4 sm:px-6 lg:px-8 transition-colors duration-500 ${
        isDarkMode ? 'bg-gray-900' : 'bg-white'
      }`}>
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 sm:space-y-8 relative">
            ...
            <div className={`hidden md:block absolute left-1/2 -translate-x-1/2 top-0 bottom-0 w-0.5 transition-colors duration-500 ${
            ...
            {experiences.map((exp, index) => (
              ...
              >
                ...
                <div className={`hidden md:block absolute left-1/2 -translate-x-1/2 -translate-y-1/2 top-1/2 w-3 h-3 sm:w-4 sm:h-4 bg-gradient-to-r from-violet-500 to-purple-400 rounded-full border-4 shadow-lg transition-colors duration-500 ${
                  isDarkMode ? 'border-gray-900' : 'border-white'
                }`} />

                <div className="md:ml-0 md:w-full">
                  <div className={`p-5 sm:p-6 rounded-2xl border transition-all duration-300 hover:shadow-lg hover:scale-105 ${
                    isDarkMode 
                    ...
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2 sm:gap-0 mb-3 sm:mb-4">
                      ...
                      <span className={`text-xs sm:text-sm font-medium px-2 py-1 sm:px-3 sm:py-1 rounded-full self-start ${
      ...
      {/* Contact Section */}
      <section id="contact" className={`py-16 sm:py-24 px-4 sm:px-6 lg:px-8 transition-colors duration-500 ${
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 sm:gap-12">
            <div className="space-y-6 sm:space-y-8">
              ...
              <div className="space-y-3 sm:space-y-4">
                <a href="mailto:winnerbrown9@gmail.com" className={`flex items-center gap-3 sm:gap-4 p-3 sm:p-4 rounded-xl border transition-all group hover:scale-105 ${
                  isDarkMode 
                ...
                <a href="tel:+2348142310497" className={`flex items-center gap-3 sm:gap-4 p-3 sm:p-4 rounded-xl border transition-all group hover:scale-105 ${
                  isDarkMode 
                    ? 'bg-gray-800 border-gray-700 hover:border-violet-700 hover:shadow-lg hover:shadow-violet-900/30' 
                    : 'bg-white border-gray-200 hover:border-violet-300 hover:shadow-lg'
                }`}>
              ...
              <div className="pt-2">
                ...
                <div className="flex gap-3">
                  <a href="https://github.com/winnerdebest" target="_blank" rel="noopener noreferrer" className={`w-10 h-10 sm:w-12 sm:h-12 rounded-lg flex items-center justify-center transition-all hover:scale-110 ${
                    isDarkMode ? 'bg-gray-800 hover:bg-violet-900/50 text-gray-300' : 'bg-gray-100 hover:bg-violet-100 text-gray-700'
                  }`}>
                    <Github className="w-5 h-5 sm:w-6 sm:h-6" />
                  </a>
                  <a href="https://linkedin.com/in/winner-orluvictor-944175333" target="_blank" rel="noopener noreferrer" className={`w-10 h-10 sm:w-12 sm:h-12 rounded-lg flex items-center justify-center transition-all hover:scale-110 ${
                  ...
                  <a href="https://x.com/buildwithwinner" target="_blank" rel="noopener noreferrer" className={`w-10 h-10 sm:w-12 sm:h-12 rounded-lg flex items-center justify-center transition-all hover:scale-110 ${
            ...
            <form className="space-y-4 sm:space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-3 py-2.5 sm:px-4 sm:py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-200 transition-all text-sm sm:text-base ${
                      isDarkMode 
              ...
              <div>
                ...
                <textarea
                  ...
                  className={`w-full px-3 py-2.5 sm:px-4 sm:py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-200 transition-all resize-none text-sm sm:text-base ${
                    isDarkMode 
                      ? 'bg-gray-800 border-gray-700 text-gray-100 placeholder-gray-500 focus:border-violet-600' 
                      : 'bg-white border-gray-300 focus:border-violet-500'
                  }`}
      ...
      {/* Footer */}
      <footer className={`py-8 sm:py-12 px-4 sm:px-6 lg:px-8 border-t transition-colors duration-500 ${
